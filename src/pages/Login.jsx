...
const Login = () => {
    ...
    const { backendUrl, setIsLoggedIn, getUserData } = useContext(AppContent);  // Changed setLoggedIn to setIsLoggedIn
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (state === 'Sign Up') {
                ...
                if (data.success) {
                    setIsLoggedIn(true);  // Changed setLoggedIn to setIsLoggedIn
                    getUserData();
